...
RSpec.describe AddressBook do
  ...
  describe "#binary_search" do
    it "searched Address for a non-existent entry" do
      book.import_from_csv("entries.csv")
  ...
  describe "#iterative_search" do
    ...
    it "searches AddressBook via iterative_search for Bill" do
      book.import_from_csv("entries.csv")
    ...
    it "searches AddressBook via iterative_search for Bob" do
      book.import_from_csv("entries.csv")
    ...
    it "searches AddressBook via iterative_search for Joe" do
      book.import_from_csv("entries.csv")
    ...
    it "searches AddressBook via iterative_search for Sally" do
      book.import_from_csv("entries.csv")
    ...
    it "searches AddressBook via iterative_search for Sussie" do
      book.import_from_csv("entries.csv")
    ...
    it "searches AddressBook via iterative_search for Billy" do
      book.import_from_csv("entries.csv")
